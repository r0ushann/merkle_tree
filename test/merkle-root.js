...
describe("Check if merkle root is working", function() {
    it("Should be able to verify if a given address is in whitelist or not", async function() {
        ...
        //Deploy of the Whitelist contract
        ...
        //Proof the Merkle Proof to the contract , and ensure that it can verify that this leaf node was indeed part of the merkle tree
